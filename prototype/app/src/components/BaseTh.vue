          ...
          <div class="space-y-2.5">
            ...
            <template v-if="isOptionType">
              <div class="space-y-1">
                ...
                <BaseComboBox
                  v-model="tempValue"
                  :options="formattedOptionsWithAll"
            ...
            <template v-else>
              ...
              <div class="space-y-1">
                ...
                <BaseComboBox
                  ...
                  placeholder="Chọn toán tử điều kiện"
                />
              </div>
              ...
              <div class="space-y-1">
                ...
                <input
                  ...
                  type="date"
                  v-model="tempValue"
                  class="w-full bg-surface-container-lowest border border-outline-variant/80 hover:border-outline-variant focus:border-primary rounded-lg px-3 py-1.5 text-xs text-on-surface focus:ring-2 focus:ring-primary/40 outline-none transition-all font-medium"
...
const formattedOptionsWithAll = computed(() => {
  const list = [
    { label: '-- Tất cả giá trị --', value: '' }
  ];
  props.options.forEach(opt => {
    if (typeof opt === 'object' && opt !== null) {
      list.push({ label: opt.label ?? opt.value, value: opt.value });
    } else {
      list.push({ label: String(opt), value: opt });
    }
  });
  return list;
});

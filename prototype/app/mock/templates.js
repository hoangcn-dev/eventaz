/**
 * EventAZ Mock Data - Event Templates Library (Module 01: FR-01.5)
 */
...
const defaultTemplates = [
    {
        ...
        isGlobal: true, // Template chung toàn hệ thống
...
window.EventAZMockData.getTemplateById = function (templateId) {
    const templates = window.EventAZMockData.getTemplates();
    return templates.find(t => t.id === templateId) || null;
};

window.EventAZMockData.saveTemplate = function (newTemplate) {
    const templates = window.EventAZMockData.getTemplates();
